...
const HistoryRoom = () => {
    ...
    const columnConfigs: ColumnConfig[] = [
        ...
        { label: t("room.response.description"), accessorKey: "description" },
        {
        ...
        {
            label: t("room.response.createdAt"),
            accessorKey: "createdAt",
            isSort: true,
            hasDate: true,
        },
        {
            label: t("room.response.updatedAt"),
            ...
            <div className="pb-5 rounded-t-sm bg-background rounded-b-sm">
                <div className="h-full bg-background rounded-t-sm">
                    <div className="flex px-5 py-3 justify-between items-center">
                        <h3 className="font-semibold">{t("room.titleHistory")}</h3>
                        <div className="flex gap-2">
