  ...
  return (
    <div className="bg-background rounded-md w-full p-4 flex flex-col gap-4">
      <div className="flex justify-between items-center mb-3">
        <h3 className="font-semibold text-lg">Dịch vụ phòng: {room?.roomCode || NA}</h3>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-10 text-gray-500">Chưa có dịch vụ nào trong phòng</div>
      ) : (
          ...
          {Object.entries(serviceStatusColumns).map(([statusKey, label]) => (
            ...
            >
              ...
              {groupedServices[statusKey].length === 0 ? (
                <div className="text-gray-500 text-sm">Không có dịch vụ</div>
              ) : (
