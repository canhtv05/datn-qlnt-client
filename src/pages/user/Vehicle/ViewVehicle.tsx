...
import { Car, Bike, Truck, FileText, ArrowLeft } from "lucide-react";
...
const VehicleCards = () => {
  ...
  return (
    <Overlay>
      <div className="bg-background rounded-md w-full max-h-[90vh] overflow-y-auto p-6">
        {/* Tiêu đề trang */}
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-lg shadow hover:shadow-lg hover:from-gray-300 hover:to-gray-400 transition text-sm font-semibold"
          >
